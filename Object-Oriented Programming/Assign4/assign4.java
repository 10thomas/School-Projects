...
public class assign4 extends JPanel 
{
  ...
  public static void addController(String vehicleType)
  {
    JFrame f2 = new JFrame(vehicleType);
    vehicleCommands(f2);
    f2.pack();
  ...
  public static void vehicleCommands(JFrame f)
  {
    int x = 3;
    int y = 3;
    ...
    JRadioButton r2=new JRadioButton("Straight"); 
    JRadioButton r3=new JRadioButton("Right"); 
  ...
  public static void RadioButtonExample(String vehicleType)
  {    
      JFrame f=new JFrame(vehicleType);     
      JRadioButton r1=new JRadioButton("Left");    
      JRadioButton r2=new JRadioButton("Straight");    
      JRadioButton r3=new JRadioButton("Right");    
      //r1.setBounds(10,10,100,30);    
      //r2.setBounds(10,30,200,31);    
      //r3.setBounds(10,50,100,30); 
  ...
  public static void main (String args[])
  {
    ...
    readBoard r1 = new readBoard();
    r1.run();
    r1.printBoard();
    board = r1.returnBoard();

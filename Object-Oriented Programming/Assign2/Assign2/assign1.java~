  ...
  public void paintComponent(Graphics g) 
  {
    ...
    for(int i = 0; i < 10; i++)
    {
      for(int j = 0; j < 10; j++)
      {
        ...
        else if ( board[j][i] == "vr") //forward right lane
        {
        ...
        else if ( board[j][i] == "vl") //forward left lane
        {
          g.setColor(Color.black);
          g.fillRect(i*50, j*50, 50, 50);
        }
        else if ( board[j][i] == "hb") //side left lane
        {
          g.setColor(Color.black);
          g.fillRect(i*50, j*50, 50, 50);
          g.setColor(Color.yellow);
        ...
        else if ( board[j][i] == "ht") //side left lane
        {
          g.setColor(Color.black);
          g.fillRect(i*50, j*50, 50, 50);
        }
